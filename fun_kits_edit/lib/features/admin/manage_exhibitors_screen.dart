...
class _ManageExhibitorsScreenState extends State<ManageExhibitorsScreen> {
  ...
  void _showQr(ExhibitorModel ex) {
    showDialog(
      context: context,
      builder: (_) => AlertDialog(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
        title: Text(ex.name, style: const TextStyle(fontWeight: FontWeight.w800)),
        content: SizedBox(
          width: 260,
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Visitors scan this to enter the booth — its theme, logo, and games load automatically.',
        ...
        trailing: Row(
          ...
          children: [
            IconButton(
                ...
                tooltip: 'View booth QR code',
                color: exhibitor.themeColor,
                onPressed: onShowQr),
            IconButton(
