...
public class EncryptionUtils {
    ...
    // Initialize and generate the key if it doesn't exist
    ...
    public static String encrypt(String plainTextPassword) throws Exception {
        ...
        // Combine IV and encrypted data, then encode to Base64 to store as a String
    ...
    public static String decrypt(String encryptedDataString) throws Exception {
        ...
        // Extract the 12-byte IV (Standard for GCM)
        byte[] iv = new byte[12];
        System.arraycopy(combined, 0, iv, 0, 12);
        GCMParameterSpec spec = new GCMParameterSpec(128, iv);

        // Extract the actual encrypted password bytes
