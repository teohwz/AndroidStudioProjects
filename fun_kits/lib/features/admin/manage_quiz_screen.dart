...
class _ManageQuizScreenState extends State<ManageQuizScreen> {
  ...
  void _openQuizSheet([QuizModel? existing]) {
    showModalBottomSheet(
      ...
      builder: (_) => _QuizFormSheet(fs: _fs, existing: existing),
    );
  }
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  subtitle: Text(
                      ...
                      'Exhibitor: ${q.exhibitorId.isEmpty ? "None" : q.exhibitorId}'),
                  trailing: Row(
...
class _QuizFormSheet extends StatefulWidget {
  const _QuizFormSheet({required this.fs, this.existing});
...
class _QuizFormSheetState extends State<_QuizFormSheet> {
  ...
  late final TextEditingController _exhibitorCtrl;
  ...
  void initState() {
    ...
    _exhibitorCtrl = TextEditingController(text: e?.exhibitorId ?? '');
  ...
  @override
  void dispose() {
    _titleCtrl.dispose(); _exhibitorCtrl.dispose(); super.dispose();
  }
  ...
  Future<void> _save() async {
    ...
    final quiz = QuizModel(
      ...
      exhibitorId: _exhibitorCtrl.text.trim(),
        ...
        child: Form(
          ...
          child: ListView(
            ...
            children: [
              ...
              const SizedBox(height: 12),
              TextFormField(
                controller: _exhibitorCtrl,
                decoration: _deco('Exhibitor ID (optional)'),
              ),
              const SizedBox(height: 12),
              Row(
                children: [
